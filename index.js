...
var stringifyLoginDetails = function (username, password) {
...
server.get('/ping', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        req.log.info("pingpong for " + req);
        return [2 /*return*/, 'pong'];
    });
}); });
server.get('/auth', {
    preValidation: function (request, reply) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, username, password;
        return __generator(this, function (_b) {
            _a = request.query, username = _a.username, password = _a.password;
            request.log.info(stringifyLoginDetails(username, password));
            return [2 /*return*/, username !== 'admin' ? new Error('must be admin') : undefined];
        });
    }); }
